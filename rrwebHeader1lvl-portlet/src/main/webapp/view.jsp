    ...
    <div class="container-fluid">
        <div id="top_panel">
            ...
            <div id="top_location" class="top_location js-openContainer" style="position: relative;">
                ...
                %>
                <div class="current_location js-open" data-regionid="<%= currentRegionId%>"><%= currentRegionName%>
                </div>
                <div class="search_location js-openBox">
                    ...
                    <form id="current_location_form" onsubmit="$('#region').blur();return false;" class="pure-form">
                        <div id="current_location_form">
                            <div class="input">
                                <input name="region" type="text" placeholder="Укажите регион" autocomplete="off"
                                       data-kladr-type="region" id="region" autofocus type="text">
            ...
            <div class="top_link">
                <a style="margin-right: 10px;" id="no_see" href="./?contrast=Y">
                    <img src="/rrwebRootMainTemplate-theme/images/eye.png" alt="Версия для слабовидящих" width="106"
                         height="71">
        ...
        <header id="banner" role="banner" class="vm aliluya">
            <div id="heading">
                ...
                <div class="top_contact_block">
                    ...
                    <div class="phone_number"><a style="text-decoration: none" href="skype:88001003434?call">8 (800)
                        100-34-34</a></div>
                    <div class="grey">Звонок из регионов России бесплатный</div>
                </div>
                <div class="top_contact_block">
                    <div>Телефон доверия:</div>
                    <div class="phone_number"><a style="text-decoration: none" href="skype:84959173825?call">(495)
                        917-38-25</a></div>
                </div>
                <div class="soc_block">
...
<div class="parallax_box" style="width: 1000px; margin: 0 auto;">
    <div class="parallax_title" style="position: relative; z-index: 2;">
        <div class="H1"><%=  themeDisplay.getLayout().getName(themeDisplay.getLocale()) %>
        </div>
    </div>
    <div class="parallax inner_parallax" style="overflow: hidden; width: 1000px;"></div>
</div>